package com.vision_classes.model.installment;
...
import com.vision_classes.activities.InstallmentOrderListActivity;
...
//        holder.btnInstallmentDetails.setVisibility(View.GONE);
        ...
        if (itemInstallmentLists.get(position).getStatus().equals("completed")){
            holder.tvDueDate.setTextColor(Color.GREEN);
        }

//        holder.tvDueDate.setText(itemInstallmentLists.get(position).getDueDate());
        holder.tvDueDate.setText(itemInstallmentLists.get(position).getPayment_status());
        ...
        if (itemInstallmentLists.get(position).getPayment_status().equals("paid")) {
            ...
            holder.btnPay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(context, "You have to pay "+itemInstallmentLists.get(position).getPendingAmount().toString(), Toast.LENGTH_SHORT ).show();
                }
            });
        }
