...
import static com.vision_classes.activities.DashboardActivity.instituteForProfile;
...
//        });
        ...
        expo_prev = mileStoneVideoView.findViewById(R.id.exo_prev);
        exo_next = mileStoneVideoView.findViewById(R.id.exo_next);
        exo_progress = mileStoneVideoView.findViewById(R.id.exo_progress);
