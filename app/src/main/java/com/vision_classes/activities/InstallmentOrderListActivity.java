...
import com.vision_classes.model.InstallmentOrderList.ItemInstallmentOrderAdapter;
import com.vision_classes.model.InstallmentOrderList.ItemInstallmentOrderList;
...
public class InstallmentOrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("INSTALLMENT LIST", getInstallmentList.toString());
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        if (payment_history.length() == 0) {
                            ...
                            Toast.makeText(InstallmentOrderListActivity.this, "Details not available", Toast.LENGTH_SHORT).show();
                            onBackPressed();
