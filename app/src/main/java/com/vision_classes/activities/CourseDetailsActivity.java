...
import com.vision_classes.coupons.ItemCoupon;
import com.vision_classes.coupons.ItemCouponAdapter;
import com.vision_classes.helperClasses.JSONParser;
import com.vision_classes.model.chapters.ItemChapter;
import com.vision_classes.model.chapters.ItemChapterAdapter;
import com.vision_classes.model.milestone.ItemMileStone;
import com.vision_classes.model.myCourses.ItemMyCourse;
import com.vision_classes.model.subscription.ItemSubscription;
import com.vision_classes.model.subscription.ItemSubscriptionAdapter;
import com.vision_classes.profile.EditProfileActivity;
...
import static com.vision_classes.activities.DashboardActivity.myCoursesList;
...
//    SimpleExoPlayer player;
    PlayerView previewVideo;
    androidx.media3.exoplayer.SimpleExoPlayer player;
...
//                                player = new SimpleExoPlayer.Builder(CourseDetailsActivity.this).build();
                                player = new androidx.media3.exoplayer.SimpleExoPlayer.Builder(CourseDetailsActivity.this).build();
...
////                                        subsPrice = Integer.parseInt(subscriptionMonth.getString(subscriptionJsonArray.getString(i)));
                                ...
                                previewVideoURI = Uri.parse(dataObj.getString("promo_video_link"));
//                                MediaItem mediaItem = MediaItem.fromUri(previewVideoURI);
                                androidx.media3.common.MediaItem mediaItem = androidx.media3.common.MediaItem.fromUri(previewVideoURI);
//                                player = new SimpleExoPlayer.Builder(CourseDetailsActivity.this).build();
                                player = new SimpleExoPlayer.Builder(CourseDetailsActivity.this).build();
                                previewVideo.setPlayer(player);
                                player.setMediaItem(mediaItem);
