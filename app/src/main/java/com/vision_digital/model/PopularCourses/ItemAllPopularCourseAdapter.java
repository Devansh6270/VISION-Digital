...
import com.vision_digital.model.myCourses.ItemMyCourseViewHolder;

import java.util.List;

public class ItemAllPopularCourseAdapter extends RecyclerView.Adapter<PopularCoursesViewHolder> {

    List<ItemMyCourse> myCourseList;
    Context context;

    public ItemAllPopularCourseAdapter(List<ItemMyCourse> myCourseList) {
    ...
    public PopularCoursesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PopularCoursesViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_all_popular_course, parent, false));
    }
