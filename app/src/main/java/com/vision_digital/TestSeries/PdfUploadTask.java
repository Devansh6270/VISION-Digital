...
public class PdfUploadTask extends AsyncTask<Void, Void, String> {
    ...
    public PdfUploadTask(String apiUrl, Map<String, String> params, File pdfFile , Context context) {
        this.apiUrl = apiUrl;
        this.params = params;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            multipartFormData.addFile("test_upload", pdfFile);
